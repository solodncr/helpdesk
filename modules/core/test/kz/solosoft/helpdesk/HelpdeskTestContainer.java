...
public class HelpdeskTestContainer extends TestContainer {

    public HelpdeskTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "kz/solosoft/helpdesk/app.properties",
    ...
    public static class Common extends HelpdeskTestContainer {

        public static final HelpdeskTestContainer.Common INSTANCE = new HelpdeskTestContainer.Common();
